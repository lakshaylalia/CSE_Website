...
export default function Home() {
  return (
    <div>
      ...
      <Video />
      <section>
        <div className="container1 h-[50vh] lg:h-screen w-full flex flex-col lg:flex-row ">
          <div className="leftSection text-white flex flex-col gap-8 relative h-[50%] lg:h-[100%] w-full lg:w-[50%]  justify-center lg:justify-end items-center lg:items-start">
            <Image
            ...
            <div className="relative z-10 p-6  flex flex-col gap-6 text-left">
              <h1 className="text-4xl lg:text-5xl font-bold hover:underline decoration-white animate-top">
                Diverse Communities
              </h1>
              <p className="text-2xl leading-10 lg:mt-4 lg:text-lg animate-top">
          ...
          <div className="rightSection text-white h-[50%] lg:h-[100%]">
            ...
            <div className="lifeAtNith h-full flex flex-col gap-4 p-6 relative justify-center lg:justify-end items-center lg:items-start">
              <video
              ...
              <div className="relative z-10  flex flex-col gap-10 animate-top">
                <h1 className="text-4xl lg:text-5xl font-bold hover:underline decoration-white font-mono">
                  Life at NITH
                </h1>
                <p className="text-xl leading-10 lg:mt-4 lg:text-lg animate-top">
        ...
        <div className="container2 h-[60vh] lg:h-screen w-full grid grid-rows-3 grid-cols-2 lg:grid-rows-2 lg:grid-cols-3 text-white ">
      ...
      <div className="upcommingEvents h-[40vh] lg:h-[80vh] w-full pt-10">
        <p className="text-5xl text-[#1b2f6e] font-semibold ml-[8%] mb-10 animate-top">
          Upcoming Events
        </p>
        <div className="evnetContainer grid grid-rows-3 grid-cols-2 gap-y-12 h-[80%] lg:grid-cols-3 lg:grid-rows-2 lg:gap-y-8  lg:h-[60%] pl-4 left-animate">
          <div className="event1 border-2 border-gray-400  h-30 lg:h-40 w-[90%] self-center p-2 flex flex-col gap-4">
            ...
            <p>
              <Link
                ...
                target="_blank"
                className="text-md lg:text-lg hover:underline"
              >
          ...
          <div className="event2 border-2 border-gray-400 h-30 lg:h-40 w-[90%] self-center p-2 flex flex-col gap-4 ">
          ...
          <div className="event3 border-2 border-gray-400 h-30 lg:h-40 w-[90%] self-center p-2 flex flex-col gap-4 e">
          ...
          <div className="event4 border-2 border-gray-400 h-30 lg:h-40 w-[90%] self-center p-2 flex flex-col gap-4 ">
          ...
          <div className="event5 border-2 border-gray-400 h-30 lg:h-40 w-[90%] self-center p-2 flex flex-col gap-4 ">
          ...
          <div className="event6 border-2 border-gray-400 h-30 lg:h-40 w-[90%] self-center p-2 flex flex-col gap-4 ">
            <p className="text-gray-600">11 Nov 2024</p>
            <p>
              <Link
